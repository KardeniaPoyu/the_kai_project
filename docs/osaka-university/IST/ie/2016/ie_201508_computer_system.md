---
sidebar_label: "2015年8月実施 計算機システム"
tags:
  - Osaka-University
  ...
  - Cache
---
# 大阪大学 情報科学研究科 情報工学 2015年8月実施 計算機システム

## **Author**
KardeniaPoyu

## **Description**
本問は計算機システムとシステムプログラム（計算機構成）に関する問題である。主に CPU アーキテクチャ、命令パイプラインの解析、データ/構造ハザードの処理、およびキャッシュの性能計算について問う。
